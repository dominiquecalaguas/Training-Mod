...
function VisuallyHiddenInput<T = InputValue>(
  ...
  const prevValueRef = React.useRef<
    T | boolean | string | Record<string, unknown> | Array<unknown> | undefined
...
const ColorPickerStoreContext =
  React.createContext<ColorPickerStore | null>(null)
...
type ColorPickerFormatSelectProps = Omit<
