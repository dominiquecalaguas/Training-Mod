...
export const editorTheme: EditorThemeClasses = {
  ...
  rtl: "text-right",
  heading: {
    // Match paragraph rhythm (leading/margins); sizes are explicit per product spec.
    h1: "leading-7 [&:not(:first-child)]:mt-6 text-[20px] font-bold tracking-normal",
    h2: "leading-7 [&:not(:first-child)]:mt-6 text-base font-bold tracking-normal",
